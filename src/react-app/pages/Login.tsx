...
export default function Login() {
  const { user, isLoading, error: authError, signInWithGoogle } = useSupabaseAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Tabernaculo-Connect
          </h1>
        ...
        <div className="space-y-6">
          <div className="text-center">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Acesso</h2>
          ...
          <div className="text-center">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-gray-500">Recursos do sistema</span>
              </div>
            </div>
          </div>
